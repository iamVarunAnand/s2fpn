...
def downsamp(img, level):
    ...
    # output_img_path = f"figs/op/bl_laplacian.html"
    # mp.plot(ico_down.vertices, ico_down.faces, c=out[1], shading={"point_size": 0.5}, filename=output_img_path)
...
if __name__ == "__main__":
    ...
    ico = Icosphere(level=level - 1)
    mp.plot(ico.vertices, ico.faces, c=out, shading={"point_size": 0.5}, filename=output_img_path)
